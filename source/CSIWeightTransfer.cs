...
namespace CSITools
{
    public class CSIWeightTransfer : PartModule 
    {
        [KSPField]
        ...
        public override void OnStart(StartState state)
        {
            ...
            {
                Tools.LogFormatted("CSIWeightTransfer Started");
            }
            trusschecker();
        }
        ...
        private void trusschecker()
        {
            if (part.parent != null)
            {
                ...
                if (part.parent.FindModuleImplementing<CSITruss>() == true)
                {
                    if (Tools._debug == true)
                    {
                        Tools.LogFormatted("Parent contains CSITruss, parent = " + part.parent);
                    }
                    _trussattached = true;
                    WeightTransfer();
                }
                else
                {
                    if (Tools._debug == true)
                    {
                        Tools.LogFormatted("Parent does not contain CSITruss");
                    }
        ...
        ///Set physics significance depending on presence of rear truss module (CSITruss)
